...
var Swippor = /** @class */ (function () {
    function Swippor() {
        ...
        this.transitionEndHandler = function (evt) {
            var _a;
            var position = Swippor.getSwipporDatasetAttribute(evt.currentTarget);
        ...
        this.touchStartHandler = function (evt) {
            var _a, _b;
            evt.preventDefault();
            _this.setCurrentWorkingPosition(Swippor.getSwipporDatasetAttribute(evt.currentTarget));
        ...
        this.touchEndHandler = function (evt) {
            ...
            //Current and to be shown elements
            var _b = _this.getElements(isMovingHandRight, position), currentShowingElement = _b.currentShowingElement, nextShowingElement = _b.nextShowingElement, previousElement = _b.previousElement, morePrev = _b.morePrev;
            //Check swiping orientation by isMovingHandLeft and position
            //Used to check for normal swiping or swiping towards null element
            //It emits only the initial swipe direction
            //Resets when the element resets to its original position
